...
import { LayoutDashboard, Users, MapPin, Trophy, LogOut } from "lucide-react";
    ...
    <div className="flex h-screen w-full bg-background overflow-hidden">
      ...
      <aside className="w-64 border-r border-border bg-card flex flex-col hidden md:flex">
        ...
        <div className="p-4 flex-1 flex flex-col gap-1 overflow-y-auto">
          <div className="text-xs font-semibold text-muted-foreground mb-2 px-2 uppercase tracking-wider">Overview</div>
          {navItems.map((item) => {
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden">
        {/* Mobile Header */}
        <header className="h-14 md:hidden border-b border-border bg-card flex items-center justify-between px-4">
          <div className="flex items-center gap-2">
